...
void BuildFrame(BYTE *pFrame, int view)
{
	...
	//struct POINT2D p0 = {0, 500, 255, 255, 255};
	//struct POINT2D p1 = {800, 500, 255, 255, 255};
	//struct POINT2D p2 = {800, 0, 255, 255, 255};
	//struct POINT2D p3 = {500, 200, 255, 255, 255};
	//struct POINT2D p4 = {100, 100, 255, 255, 255};
	//struct POINT2D p5 = {400, 300, 255, 255, 255};
	//struct POINT2D *poly[6] = {&p0, &p1, &p2, &p3, &p4, &p5};
	//fill_poly(poly, 6, pFrame);
	//draw_poly(poly, 6, pFrame);
	sleep(1);
}
